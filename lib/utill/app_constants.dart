...
class AppConstants {
  static const String APP_NAME = 'costa coffee';
  ...
  static const String FORGET_PASSWORD_URI = '/api/v1/auth/forgotPassword';
  static const String VERIFY_TOKEN_URI = '/api/v1/auth/verifyToken';
  static const String RESET_PASSWORD_URI = '/api/v1/auth/resetPassword';
  static const String CHECK_PHONE_URI = 'api/v1/auth/checkPhone?phone=';
  static const String VERIFY_PHONE_URI = '/api/v1/auth/verifyPhone';
  static const String CHECK_EMAIL_URI = '/api/v1/auth/checkEmail';
  static const String VERIFY_EMAIL_URI = '/api/v1/auth/verifyEmail';
  static const String REGISTER_URI = '/api/v1/auth/sth';
